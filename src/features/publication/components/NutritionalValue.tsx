...
export default function NutritionalValue({ nutrition }: NutritionalValueProps) {
    return (
        <div className="flex flex-col mt-5 gap-3 items-center"> {/* Блок кбжу */}
            <div className="flex gap-4 items-center">
                <div className='flex flex-col items-center w-[116px] h-[96px] pt-[5px] bg-[#23A6F0] rounded-[10px]'>
                    ...
                    <div className='flex flex-col items-center justify-center gap-[1px] w-[100px] h-[51px] bg-[#FFFFFF] rounded-[10px]'>
                        <span className='font-montserrat text-[14px] p-0 font-bold tracking-[0.2px] leading-4'>{nutrition?.calories}</span>
                ...
                <div className='flex flex-col items-center w-[116px] h-[96px] pt-[5px] bg-[#23A6F0] rounded-[10px]'>
                    ...
                    <div className='flex flex-col items-center justify-center gap-[1px] w-[100px] h-[51px] bg-[#FFFFFF] rounded-[10px]'>
                        <span className='font-montserrat text-[14px] p-0 font-bold tracking-[0.2px] leading-4'>{nutrition?.protein}</span>
                ...
                <div className='flex flex-col items-center w-[116px] h-[96px] pt-[5px] bg-[#23A6F0] rounded-[10px]'>
                    ...
                    <div className='flex flex-col items-center justify-center gap-[1px] w-[100px] h-[51px] bg-[#FFFFFF] rounded-[10px]'>
                        <span className='font-montserrat text-[14px] p-0 font-bold tracking-[0.2px] leading-4'>{nutrition?.fat}</span>
                        <span className='font-montserrat text-[14px] p-0 font-light tracking-[0.2px] leading-4 text-black'>грамм</span>
                    </div>
                </div>
                ...
                <div className='flex flex-col items-center w-[116px] h-[96px] pt-[5px] bg-[#23A6F0] rounded-[10px]'>
                    ...
                    <div className='flex flex-col items-center justify-center gap-[1px] w-[100px] h-[51px] bg-[#FFFFFF] rounded-[10px]'>
                        <span className='font-montserrat text-[14px] p-0 font-bold tracking-[0.2px] leading-4'>{nutrition?.carbs}</span>
                        <span className='font-montserrat text-[14px] p-0 font-light tracking-[0.2px] leading-4 text-black'>грамм</span>
                    </div>
                </div>
            </div>
            <p className='font-montserrat text-[13px] font-light tracking-[0.2px] leading-4'>Пищевая ценность на 100 г. Калорийность рассчитана для сырых продуктов.</p>
        </div>
    )
}