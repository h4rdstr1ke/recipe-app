...
export default function RecipeRating({ rating }: RecipeRating) {
    return (
        <div className='w-[100%] relative mt-[29px] py-[14px]'>{/* Оценка рецепта */}
            ...
            <div className='flex items-center w-[100%] h-[160px] gap-[14px] px-[25px] border-[2px] border-[#23A6F0] rounded-[10px]'>
                ...
                <div className='flex flex-col border-l-[1px] pl-2 border-[#D1D1D1]'>
                    <div className='w-[56px] h-[30px] flex justify-start items-center gap-1'>
                        <span className='font-montserrat text-[20px] text-[#000000] tracking-[0.2px] font-bold leading-5'>{rating?.rating}</span>
