            ...
            <div className="md:max-w-[638px] w-[100%] flex flex-col">
                ...
                <div className="flex flex-col w-[100%] border-[2px] rounded-[10px] border-[#E6E6E6] px-[20px] py-[15px]">
                    <div className="flex flex-col gap-3">
                        ...
                        <Input placeholder="Картошка по деревенски" />
                    </div>
                    <div className="flex flex-col gap-3 mt-3">
                        ...
                        <div className="flex justify-between rounded-[5px] bg-[#F9F9F9] border-[1px] border-[#E6E6E6]">
                            <Input placeholder="Вкусная картошка с домашним майонезом и кетчупом, специями"
                    ...
                    <div className="flex flex-col gap-3 mt-3">
                        ...
                        <Input placeholder="5" className="max-w-[75px] text-center" />
                    </div>
                    <div className="flex flex-col gap-3 mt-3">
                        <div className="flex items-center gap-1">
                ...
                <div className="flex flex-col w-[100%] px-[20px] mt-[30px]">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex justify-between items-center w-[100%]">
                            <span className="font-montserrat font-light text-[16px] text-[#000000] tracking-[0.2px] leading-7 underline">Соль</span>
                            <span className="font-montserrat font-light text-[16px] text-[#000000] tracking-[0.2px] leading-7">100 гр</span>
                        </div>
                        <Delete className="w-[16px] text-[#BFBFBF]" />
                    </div>
                    {/* Ингредиент */}
                    <div className="flex items-center gap-4 ">
                        <div className="flex justify-between items-center w-[100%]">
                            <span className="font-montserrat font-light text-[16px] text-[#000000] tracking-[0.2px] leading-7 underline">Майонез</span>
                            <span className="font-montserrat font-light text-[16px] text-[#000000] tracking-[0.2px] leading-7">100 гр</span>
                        </div>
                        <Delete className="w-[16px] text-[#BFBFBF]" />
                    </div>
                ...
                <div className="flex flex-col mt-[14px] gap-3">
                    <div className="flex flex-col w-[100%] border-[2px] rounded-[10px] border-[#E6E6E6] px-[23px] py-[15px]">
                        ...
                        <div className="flex justify-between items-end">
                            <img className="w-[280px] h-[170px] border-[2px] rounded-[10px] border-[#E6E6E6]" alt="photo"></img>
                            <Button className='w-[175px] h-[30px] text-[14px]'>Изменить фото</Button>
                        </div>
                ...
                <div className="flex justify-center mt-[14px] mb-[50px]">
                    <Button className='w-[350px] h-[55px] text-[20px] rounded-[9px]'>Сохранить изменения</Button> {/* Поменять rounded! */}
                </div>
            </div>
        </div >
    )
